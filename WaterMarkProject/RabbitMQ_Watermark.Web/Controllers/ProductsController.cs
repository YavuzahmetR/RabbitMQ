...
using RabbitMQ_Watermark.Web.Models;
using RabbitMQ_Watermark.Web.Services;

namespace RabbitMQ_Watermark.Web.Controllers
{
    public class ProductsController : Controller
    {
        private readonly AppDbContext _context;
        private readonly RabbitMQ_PublisherService _rabbitMQ_PublisherService;

        public ProductsController(AppDbContext context, RabbitMQ_PublisherService rabbitMQ_PublisherService)
        {
            _context = context;
            _rabbitMQ_PublisherService = rabbitMQ_PublisherService;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,Stock,ImageName")] Product product, IFormFile ImageFile)
        {
            ...
            if (ImageFile is { Length: > 0 })
            {
                ...
                _rabbitMQ_PublisherService.PublishAsync(new ProductImageCreatedEvent() { ImageName = randomImageName });
